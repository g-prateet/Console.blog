                  ...
                  <td className="px-6 py-5 whitespace-nowrap">
                    <div className="flex items-center gap-3">
                      ...
                      {isNewPost(post.created_at) && (
                        <span className="px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-[#007EA7]/10 dark:bg-[#007EA7]/20 text-[#007EA7] dark:text-[#4DB8D9] rounded-md border border-[#007EA7]/20 dark:border-[#007EA7]/30">
                          New
                        </span>
                      )}
                    </div>
